...
export const optionsUsers = {
  ...
  data: {
    ...
    data: [
      ...
      [1, '/', 'Alice Carasca', 'Software Engineer', 'offline', true],
      [2, '/13.jpg', 'Tara Svenson', 'UI/UX Designer', 'offline', true],
      [3, '', 'Mary Lebowski', 'Project Manager', 'available', true],
      [
        4,
      ...
      [5, '/2', 'Carmen Escudero', 'HR Manager', 'offline', true],
      [6, '/22.jpg', 'Dwayne Hicks', 'Product Manager', 'offline', true],
      [
        7,
      ...
      [9, '/28.jpg', 'Edouard Falant', 'Web Developer', 'busy', true],
      [
        10,
        '/images/avatars/placeholder-f.jpg',
        'Shana Williams',
      ...
      [12, '/39.jpg', 'Alejandro Badajoz', 'Web Developer', 'busy', true],
      [
        13,
        '/21.jpg',
        'Elizabeth Fisher',
      ...
      [14, '/3', 'Helmut Fritz', 'Product Manager', 'available', true],
      [15, '/31.jpg', 'Yasseen Amzi', 'Business Analyst', 'offline', true],
    ],
  },
}
