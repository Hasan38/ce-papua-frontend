...
viewWrapper.setPageTitle('Add Machine')
useHead({
  title: computed(() => 'Add Machine'),
})
...
const onSubmit = handleSubmit(async (values) => {
  ...
  try {
    ...
    notyf.success('machine berhasil ditambahkan')
  }
  catch (e: any) {
    isLoading.value = false
    if (e.status === 422) {
